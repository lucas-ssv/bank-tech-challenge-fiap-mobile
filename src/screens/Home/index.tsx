    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      ...
      <LinearGradient className='flex-1' colors={['#004D61', '#FFFFFF']}>
        ...
        <Box className='px-4 py-20'>
          ...
          <Box>
              <Text size="3xl" className="mt-12 text-black font-heading text-center">
                Vantagens do nosso banco:
              </Text>

              <Box className='flex justify-center items-center mt-20 gap-'>
                <Gift/>
                <Text size="2xl" className="mt-10 text-custom-my-green font-heading text-center">
                Conta e cartão gratuitos
                </Text>
                <Text size="xl" className="mt-6 text-custom-my-gray font-heading text-center">
              ...
              <Box className='flex justify-center items-center mt-20'>
                ...
                <Text size="xl" className="mt-6 text-custom-my-gray text-center">
